...
% ,block types and superblock types generated by wmd_read_data_simple and ThirdOrderBasis.
...
% global_data is the result from wmd_read_data_simple+ThirdOrderBasis
%% Preprocessing
%Load parameters from global_data (see wmd_read_data_simple.m &
%ThirdOrder_Basis.m for description)
...
% If SecondOrder is being called from inside PhenoRipper, it updates the
% timing bar
