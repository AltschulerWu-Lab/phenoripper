function turnOnBorder(handles)
% TURNONBORDER makes the border of a handle a specific color
%   TURNONBORDER(handles) sets the border handles for the component to be
%   on
%
...
% ------------------------------------------------------------------------------
    ...
    colorBorder = javax.swing.border.LineBorder(java.awt.Color.red,4,0);
